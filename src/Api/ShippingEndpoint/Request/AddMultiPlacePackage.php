...
use ShiptorRussiaApiClient\Client\Api\ShippingEndpoint\Fields\AddMultiPlacePackage\MultiPlacePackage;
use ShiptorRussiaApiClient\Client\Api\ShippingEndpoint\Request\GenericRequest as GenericShippingRequest,
    ...
    ShiptorRussiaApiClient\Client\Api\ShippingEndpoint\Model\AddMultiPlacePackage as AddMultiPlacePackageResult;
    ...
    protected function initFields(){
        $this->getFieldsCollection()
            ...
            ->Collection("departure")
                ...
                ->endCollection()
            ->endCollection()
            ->Custom("packages", MultiPlacePackage::class)->setMulty()->add()
        ;
    }
