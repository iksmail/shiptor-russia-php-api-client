...
use ShiptorRussiaApiClient\Client\Core\Model\Result,
    ...
    ShiptorRussiaApiClient\Client\Api\ShippingEndpoint\Model\AddMultiPlacePackage\Package as MultiPlacePackage,
...
class AddMultiPlacePackage extends Result{
    ...
    protected function setPackages(){
        $this->packages = new GenericCollection($this->get("packages"), MultiPlacePackage::class);
    }
